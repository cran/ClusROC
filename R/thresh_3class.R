...
#'
#' @return \code{plot.optThres3} returns plots of confidence regions of covariate-specific optimal pair of thresholds.
#'
...
#'
#' @return \code{print.optThres3} returns a summary table for results of covariate-specific optimal pair of thresholds estimation.
#'
#' @seealso \code{\link{optThres3}}
#'
#' @export
