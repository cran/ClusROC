...
#'
#' @return \code{print.lme2} returns a summary table for the estimated parameters in the cluster-effect model.
#'
...
#'
#' @return \code{plot.lme2} returns the diagnostic plots for the linear mixed-effect model, fitted by lme2.
#'
#' @seealso \code{\link{lme2}}
#'
#' @import ggplot2
